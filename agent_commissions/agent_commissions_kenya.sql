#All sales Query	
	...
	where left(C.ship_at,4) in ('2021')	
    ...
    SUM(CASE WHEN  order_business_grouping = 'Agent_Delivered_Institutional' THEN a.closed_revenue END) as 'Institutional Revenue', count(distinct a.order_id) as 'Order Count', 
